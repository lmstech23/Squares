...
/** Presets offered by the amount picker — donations §6 — and the Donate Only
 *  first-open rule (public-theme spec §5). Defined in donation-presets.ts, a
 *  pure module a client component can import; re-exported here so every
 *  existing importer of contributions.ts is unchanged. */
export { DONATION_PRESETS_CENTS, initialDonationCents } from "./donation-presets.ts";
